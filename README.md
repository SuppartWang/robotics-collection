...
> Last updated: `2026-09-26 02:25 UTC`  
> Total projects: **201**
...
- **Stars**: 3512 | **Forks**: 377 | **Language**: MDX
- **License**: Apache-2.0 | **Updated**: 2026-09-25
...
- **Stars**: 2785 | **Forks**: 161 | **Language**: Python
- **License**: MIT | **Updated**: 2026-09-26
- **Topics**: 
- **Simulation**: Mujoco
...
- **Author**: [YanjieZe](https://github.com/YanjieZe)
- **Stars**: 2718 | **Forks**: 477 | **Language**: Python
- **License**: MIT | **Updated**: 2026-09-25
- **Topics**: 
- **Simulation**: Mujoco
...
- **Stars**: 1682 | **Forks**: 335 | **Language**: Python
- **License**: NOASSERTION | **Updated**: 2026-09-25
- **Topics**: 
...
- **Stars**: 1665 | **Forks**: 148 | **Language**: None
- **License**: CC0-1.0 | **Updated**: 2026-09-24
...
- **Stars**: 1224 | **Forks**: 138 | **Language**: Python
- **License**: BSD-2-Clause | **Updated**: 2026-09-25
...
- **Author**: [menloresearch](https://github.com/menloresearch)
- **Stars**: 1219 | **Forks**: 202 | **Language**: Python
- **License**: CERN-OHL-S-2.0 | **Updated**: 2026-09-25
- **Topics**: 
- **Simulation**: Mujoco
...
- **Stars**: 946 | **Forks**: 44 | **Language**: None
- **License**: N/A | **Updated**: 2026-09-20
- **Topics**: 
- **Ros Distro**: Iron
...
- **Stars**: 832 | **Forks**: 131 | **Language**: None
- **License**: MIT | **Updated**: 2026-09-23
...
- **Stars**: 828 | **Forks**: 101 | **Language**: C#
- **License**: N/A | **Updated**: 2026-09-25
- **Topics**: 



### [asimov-v0](https://github.com/menloresearch/asimov-v0)

> v0 of Asimov, an open-source humanoid robot

- **Author**: [menloresearch](https://github.com/menloresearch)
- **Stars**: 787 | **Forks**: 96 | **Language**: None
- **License**: CERN-OHL-S-2.0 | **Updated**: 2026-09-22
...
- **Stars**: 744 | **Forks**: 83 | **Language**: Python
- **License**: NOASSERTION | **Updated**: 2026-09-25
- **Topics**: 
...
- **Stars**: 720 | **Forks**: 62 | **Language**: Python
- **License**: GPL-3.0 | **Updated**: 2026-09-01
...
- **Stars**: 569 | **Forks**: 49 | **Language**: Python
- **License**: Apache-2.0 | **Updated**: 2026-09-19
- **Topics**: 
...
- **Stars**: 544 | **Forks**: 53 | **Language**: Python
- **License**: MIT | **Updated**: 2026-09-25
- **Topics**: 
...
- **Stars**: 499 | **Forks**: 39 | **Language**: Python
- **License**: NOASSERTION | **Updated**: 2026-09-22
- **Topics**: `human-motion` `imitation-learning` `reinforcement-learning` `sim-to-real`
- **Simulation**: Isaac Gym



### [microban](https://github.com/Rhoban/microban)

> Microban is an affordable, fully 3D-printable, and 100% open-source humanoid robot. Powered by a Raspberry Pi Zero 2W and 19 Dynamixel servomotors, it serves as an accessible DIY platform for learning, experimentation, and research in robotics.

- **Author**: [Rhoban](https://github.com/Rhoban)
- **Stars**: 488 | **Forks**: 81 | **Language**: Python
- **License**: NOASSERTION | **Updated**: 2026-09-26
- **Topics**: `diy` `electronics` `engineering` `humanoid-robot` `robotics`
- **Hardware**: Raspberry Pi
...
- **Stars**: 372 | **Forks**: 74 | **Language**: C++
- **License**: Apache-2.0 | **Updated**: 2026-09-23
- **Topics**: 
- **Simulation**: Mujoco
- **Control**: MPC
...
- **Stars**: 617 | **Forks**: 73 | **Language**: Python
- **License**: MIT | **Updated**: 2026-09-23
...
- **Stars**: 300 | **Forks**: 31 | **Language**: Python
- **License**: MIT | **Updated**: 2026-09-23
...
### [NN-MPC_RobotArm](https://github.com/Xinlei143/NN-MPC_RobotArm)

> Activation-aligned asynchronous residual CEM-MPC for position-controlled manipulators with learned dynamics.

- **Author**: [Xinlei143](https://github.com/Xinlei143)
- **Stars**: 6 | **Forks**: 2 | **Language**: Python
- **License**: Apache-2.0 | **Updated**: 2026-09-16
- **Topics**: `inverse-kinematics` `model-predictive-control` `motion-planning` `mujoco` `neural-dynamics`
- **Simulation**: Mujoco
- **Control**: MPC



### [robotic-arm-5-digit-manipulator](https://github.com/ss1-ops/robotic-arm-5-digit-manipulator)

> BCN3D Moveo 6-DOF arm + custom Aero Hand gripper. ROS 2 Jazzy, ESP32-S3 micro-ROS, vision pick-and-place, full hardware/firmware/software stack.

- **Author**: [ss1-ops](https://github.com/ss1-ops)
- **Stars**: 6 | **Forks**: 0 | **Language**: Python
- **License**: MIT | **Updated**: 2026-09-23
- **Topics**: `3d-printing` `aero-hand` `arduino` `automation` `computer-vision`
...
- **Stars**: 6 | **Forks**: 1 | **Language**: C++
- **License**: N/A | **Updated**: 2026-05-06
- **Topics**: `c-plus-plus` `computervision` `cplusplus` `cpp` `graph-algorithms`
- **Ros**: ROS, ros



### [Simulation-and-control-of-4-DOF-robotic-arm](https://github.com/romankalyna/Simulation-and-control-of-4-DOF-robotic-arm)

> Simulation and PID control of a planar 4-DOF serial robot arm in Python with ROS2. Includes full dynamics, gravity compensation, FK, IK, data logging, and RViz with URDF.

- **Author**: [romankalyna](https://github.com/romankalyna)
- **Stars**: 6 | **Forks**: 0 | **Language**: Python
- **License**: MIT | **Updated**: 2026-07-28
- **Topics**: `control-systems` `forward-kinematics` `inverse-kinematics` `manipulator` `pid-control`
- **Ros**: ROS2, ROS, ros, ros2
- **Ros Distro**: Humble
- **Control**: PID
...
### [HexaArm-Mini](https://github.com/hexakinetica/HexaArm-Mini)

> Open-source desktop manipulator. A fully integrated 6-DoF robot running the HexaMotion kernel on embedded x86.

- **Author**: [hexakinetica](https://github.com/hexakinetica)
- **Stars**: 5 | **Forks**: 0 | **Language**: CMake
- **License**: N/A | **Updated**: 2026-09-22
- **Topics**: 
...
### [kinematics-robotic-arms-modern-approach](https://github.com/madibabaiasl/kinematics-robotic-arms-modern-approach)

> This repository is all the things related to the Kinematics of Robotic Manipulators: a Modern Approach Course.

- **Author**: [madibabaiasl](https://github.com/madibabaiasl)
- **Stars**: 5 | **Forks**: 0 | **Language**: None
- **License**: NOASSERTION | **Updated**: 2026-07-12
- **Topics**: 
- **Ros**: ROS2, ROS, ros, ros2
...
- **Stars**: 4 | **Forks**: 1 | **Language**: C++
- **License**: N/A | **Updated**: 2026-08-16
- **Topics**: 
- **Ros**: ROS2, ros2
- **Control**: MPC
...
### [mj_manipulator](https://github.com/personalrobotics/mj_manipulator)

> Generic MuJoCo manipulator control: planning, execution, grasping, and cartesian control for any robot arm

- **Author**: [personalrobotics](https://github.com/personalrobotics)
- **Stars**: 4 | **Forks**: 1 | **Language**: Python
- **License**: MIT | **Updated**: 2026-09-20
- **Topics**: 
- **Simulation**: Mujoco



### [warehouse-robot](https://github.com/astianmuchui/warehouse-robot)

> Semi-autonomous wheeled robot with manipulator arm

- **Author**: [astianmuchui](https://github.com/astianmuchui)
- **Stars**: 3 | **Forks**: 0 | **Language**: C++
- **License**: N/A | **Updated**: 2026-07-14
- **Topics**: 
...
- **Stars**: 30586 | **Forks**: 7417 | **Language**: Python
- **License**: NOASSERTION | **Updated**: 2026-09-25
...
- **Stars**: 13850 | **Forks**: 2184 | **Language**: Python
- **License**: MIT | **Updated**: 2026-09-25
...
- **Stars**: 11382 | **Forks**: 1327 | **Language**: Python
- **License**: Apache-2.0 | **Updated**: 2026-09-26
...
- **Author**: [makerspet](https://github.com/makerspet)
- **Stars**: 11177 | **Forks**: 699 | **Language**: Python
- **License**: Apache-2.0 | **Updated**: 2026-09-26
- **Topics**: `3d-printing` `arduino` `diy-electronics` `diy-project` `esp32`
- **Ros**: ROS2, ros2
- **Simulation**: Gazebo
- **Hardware**: Arduino, Raspberry Pi, STM32, ESP32
...
- **Stars**: 6769 | **Forks**: 1647 | **Language**: HTML
- **License**: N/A | **Updated**: 2026-09-21
- **Topics**: 
...
- **Stars**: 6703 | **Forks**: 2191 | **Language**: C++
- **License**: MIT | **Updated**: 2026-09-26
- **Topics**: 
...
- **Stars**: 6165 | **Forks**: 665 | **Language**: None
- **License**: N/A | **Updated**: 2026-09-24
...
- **Stars**: 4935 | **Forks**: 1525 | **Language**: C++
- **License**: BSD-3-Clause | **Updated**: 2026-09-24
...
- **Stars**: 4684 | **Forks**: 863 | **Language**: C++
- **License**: GPL-2.0 | **Updated**: 2026-09-25
...
- **Stars**: 4635 | **Forks**: 305 | **Language**: TeX
- **License**: N/A | **Updated**: 2026-09-23
- **Topics**: 
...
- **Stars**: 4321 | **Forks**: 797 | **Language**: Python
- **License**: GPL-3.0 | **Updated**: 2026-09-24
...
- **Stars**: 4010 | **Forks**: 958 | **Language**: C++
- **License**: NOASSERTION | **Updated**: 2026-09-24
...
- **Stars**: 3466 | **Forks**: 1157 | **Language**: C++
- **License**: N/A | **Updated**: 2026-09-22
...
- **Stars**: 3247 | **Forks**: 879 | **Language**: C++
- **License**: BSD-3-Clause | **Updated**: 2026-09-25
...
- **Author**: [cirosantilli](https://github.com/cirosantilli)
- **Stars**: 3223 | **Forks**: 291 | **Language**: HTML
- **License**: CC-BY-SA-4.0 | **Updated**: 2026-09-26
- **Topics**: `996` `censorship` `censorship-circumvention` `china` `china-dictatorship`
...
- **Stars**: 3191 | **Forks**: 379 | **Language**: Python
- **License**: NOASSERTION | **Updated**: 2026-09-23
...
- **Stars**: 3120 | **Forks**: 937 | **Language**: C++
- **License**: GPL-3.0 | **Updated**: 2026-09-25
...
- **Stars**: 2699 | **Forks**: 429 | **Language**: Python
- **License**: BSD-3-Clause | **Updated**: 2026-09-22
- **Topics**: 
- **Ml Framework**: PyTorch
...
- **Stars**: 2663 | **Forks**: 1835 | **Language**: C++
- **License**: N/A | **Updated**: 2026-09-17
...
- **Stars**: 2653 | **Forks**: 722 | **Language**: C++
- **License**: LGPL-2.1 | **Updated**: 2026-09-24
- **Topics**: 
- **Ros**: ROS, ros
...
- **Author**: [gaoxiang12](https://github.com/gaoxiang12)
- **Stars**: 2588 | **Forks**: 584 | **Language**: C++
- **License**: N/A | **Updated**: 2026-09-23
- **Topics**: 
- **Ros**: ROS, ros
...
- **Stars**: 2345 | **Forks**: 414 | **Language**: C++
- **License**: MIT | **Updated**: 2026-09-24
...
- **Stars**: 2326 | **Forks**: 457 | **Language**: C++
- **License**: MIT | **Updated**: 2026-09-24
- **Topics**: `3d-mapping` `icp` `lidar-slam` `robotics` `ros`
- **Ros**: ROS2, ROS, ros, ros2
...
- **Author**: [3D-Vision-World](https://github.com/3D-Vision-World)
- **Stars**: 2134 | **Forks**: 150 | **Language**: None
- **License**: N/A | **Updated**: 2026-09-24
...
- **Author**: [nv-tlabs](https://github.com/nv-tlabs)
- **Stars**: 2130 | **Forks**: 176 | **Language**: Python
- **License**: NOASSERTION | **Updated**: 2026-09-25
...
- **Stars**: 2065 | **Forks**: 1183 | **Language**: C++
- **License**: Apache-2.0 | **Updated**: 2026-09-23
...
- **Author**: [gege-circle](https://github.com/gege-circle)
- **Stars**: 2021 | **Forks**: 152 | **Language**: None
- **License**: N/A | **Updated**: 2026-09-25
- **Topics**: `a-soul` `acfun` `bilibili` `china` `gege-circle`
...
- **Author**: [youngguncho](https://github.com/youngguncho)
- **Stars**: 1945 | **Forks**: 348 | **Language**: None
- **License**: N/A | **Updated**: 2026-09-19
- **Topics**: 
...
- **Author**: [ANYbotics](https://github.com/ANYbotics)
- **Stars**: 1874 | **Forks**: 507 | **Language**: C++
- **License**: BSD-3-Clause | **Updated**: 2026-09-24
...
- **Stars**: 1351 | **Forks**: 597 | **Language**: C++
- **License**: BSD-3-Clause | **Updated**: 2026-09-21
...
- **Stars**: 905 | **Forks**: 109 | **Language**: C++
- **License**: BSD-3-Clause | **Updated**: 2026-09-25
...
- **Author**: [ROBOTIS-GIT](https://github.com/ROBOTIS-GIT)
- **Stars**: 529 | **Forks**: 571 | **Language**: C++
- **License**: Apache-2.0 | **Updated**: 2026-09-21
...
- **Stars**: 502 | **Forks**: 104 | **Language**: None
- **License**: N/A | **Updated**: 2026-09-10
- **Topics**: `awesome-list` `manipulation` `mobile-robots` `navigation` `odometry`
- **Ros**: ROS, ros
- **Hardware**: Jetson, Raspberry Pi
...
- **Stars**: 369 | **Forks**: 59 | **Language**: Python
- **License**: N/A | **Updated**: 2026-09-25
...
- **Author**: [botbotrobotics](https://github.com/botbotrobotics)
- **Stars**: 355 | **Forks**: 99 | **Language**: TypeScript
- **License**: MIT | **Updated**: 2026-09-25
- **Topics**: `autonomous-navigation` `computer-vision` `go2` `humanoid` `legged-robotics`
- **Ros**: ROS2, ROS, ros, ros2
- **Ros Distro**: Humble
- **Hardware**: Jetson
...
- **Stars**: 252 | **Forks**: 43 | **Language**: JavaScript
- **License**: MIT | **Updated**: 2026-09-23
- **Topics**: 
- **Ros**: ROS2, ROS, ros, ros2
- **Ros Distro**: Humble
...
- **Stars**: 15939 | **Forks**: 21450 | **Language**: C++
- **License**: GPL-3.0 | **Updated**: 2026-09-26
...
- **Stars**: 11910 | **Forks**: 892 | **Language**: Jupyter Notebook
- **License**: NOASSERTION | **Updated**: 2026-09-25
- **Topics**: 
- **Hardware**: Jetson
...
- **Stars**: 9475 | **Forks**: 1062 | **Language**: Go
- **License**: NOASSERTION | **Updated**: 2026-09-26
...
- **Stars**: 5348 | **Forks**: 1529 | **Language**: C
- **License**: GPL-3.0 | **Updated**: 2026-09-26
...
- **Stars**: 3261 | **Forks**: 465 | **Language**: C++
- **License**: Apache-2.0 | **Updated**: 2026-09-24
...
- **Stars**: 2200 | **Forks**: 509 | **Language**: C
- **License**: GPL-3.0 | **Updated**: 2026-09-25
...
- **Stars**: 2162 | **Forks**: 660 | **Language**: C++
- **License**: BSD-3-Clause | **Updated**: 2026-09-25
...
- **Author**: [learnsyslab](https://github.com/learnsyslab)
- **Stars**: 2146 | **Forks**: 569 | **Language**: Python
- **License**: MIT | **Updated**: 2026-09-25
...
- **Stars**: 1873 | **Forks**: 313 | **Language**: C++
- **License**: N/A | **Updated**: 2026-09-25
...
- **Stars**: 1071 | **Forks**: 133 | **Language**: Python
- **License**: Apache-2.0 | **Updated**: 2026-09-25
- **Topics**: 
- **Hardware**: Jetson, Raspberry Pi
...
- **Stars**: 1030 | **Forks**: 248 | **Language**: Python
- **License**: Apache-2.0 | **Updated**: 2026-09-25
...
- **Stars**: 695 | **Forks**: 34 | **Language**: Rust
- **License**: Apache-2.0 | **Updated**: 2026-09-09
...
- **Stars**: 497 | **Forks**: 84 | **Language**: C
- **License**: MIT | **Updated**: 2026-09-26
- **Topics**: `airplane` `ardupilot` `autopilot` `betaflight` `drone`
- **Hardware**: STM32, Raspberry Pi, ESP32
...
- **Author**: [ExpressLRS](https://github.com/ExpressLRS)
- **Stars**: 414 | **Forks**: 142 | **Language**: None
- **License**: N/A | **Updated**: 2026-09-22
...
- **Stars**: 409 | **Forks**: 95 | **Language**: C++
- **License**: MIT | **Updated**: 2026-09-12
...
- **Stars**: 349 | **Forks**: 93 | **Language**: C++
- **License**: NOASSERTION | **Updated**: 2026-09-21
...
- **Stars**: 269 | **Forks**: 107 | **Language**: Kotlin
- **License**: MIT | **Updated**: 2026-09-20
- **Topics**: 
...
- **Stars**: 258 | **Forks**: 27 | **Language**: C++
- **License**: BSD-3-Clause | **Updated**: 2026-08-31
...
- **Stars**: 226 | **Forks**: 43 | **Language**: Python
- **License**: MIT | **Updated**: 2026-09-11
...
- **Stars**: 169 | **Forks**: 37 | **Language**: C++
- **License**: GPL-3.0 | **Updated**: 2026-09-19
...
- **Stars**: 131 | **Forks**: 35 | **Language**: HTML
- **License**: NOASSERTION | **Updated**: 2026-09-21
...
- **Stars**: 106 | **Forks**: 23 | **Language**: GDScript
- **License**: GPL-3.0 | **Updated**: 2026-08-09
- **Topics**: 
...
- **Stars**: 105 | **Forks**: 4 | **Language**: None
- **License**: NOASSERTION | **Updated**: 2026-09-17
- **Topics**: `3d-printed-drone` `3d-printing` `aerodynamics` `betaflight` `blackbox`
- **Control**: PID



### [centauri](https://github.com/TimHanewich/centauri)
...
- **Author**: [TimHanewich](https://github.com/TimHanewich)
- **Stars**: 81 | **Forks**: 11 | **Language**: Python
- **License**: GPL-3.0 | **Updated**: 2026-09-18
- **Topics**: `3d-printing` `diy-electronics` `drone` `education` `embedded-systems`
- **Hardware**: Raspberry Pi



### [DIY-Quadcopter](https://github.com/ElektroJonas/DIY-Quadcopter)

> This repository contains the control algorithm for a quadcopter drone on an ESP32 as well as electrical schematics and a pcb design.

- **Author**: [ElektroJonas](https://github.com/ElektroJonas)
- **Stars**: 75 | **Forks**: 5 | **Language**: C++
- **License**: N/A | **Updated**: 2026-09-22
- **Topics**: 
- **Hardware**: ESP32
- **Control**: PID
...
- **Stars**: 56 | **Forks**: 18 | **Language**: None
- **License**: MIT | **Updated**: 2026-08-27
...
- **Author**: [cifertech](https://github.com/cifertech)
- **Stars**: 45 | **Forks**: 13 | **Language**: C++
- **License**: MIT | **Updated**: 2026-09-25
- **Topics**: `drone` `esp32` `flight-controller` `quadcopter`
- **Hardware**: Arduino, ESP32
- **Control**: PID
...
- **Stars**: 40 | **Forks**: 3 | **Language**: None
- **License**: N/A | **Updated**: 2026-08-19
- **Topics**: 



### [canarygc](https://github.com/judahpaul16/canarygc)

> A web-based ground control station (GCS) for remote autopilot management via MAVLink and MSP protocols.

- **Author**: [judahpaul16](https://github.com/judahpaul16)
- **Stars**: 33 | **Forks**: 3 | **Language**: TypeScript
- **License**: MIT | **Updated**: 2026-09-19
- **Topics**: `ardupilot` `betaflight` `drone` `gcs` `inav`
- **Simulation**: Gazebo
- **Hardware**: Raspberry Pi
- **Control**: PID
...
- **Stars**: 63733 | **Forks**: 11388 | **Language**: Python
- **License**: MIT | **Updated**: 2026-09-25
...
- **Stars**: 44599 | **Forks**: 5389 | **Language**: JavaScript
- **License**: AGPL-3.0 | **Updated**: 2026-09-25
...
- **Author**: [harvard-edge](https://github.com/harvard-edge)
- **Stars**: 28448 | **Forks**: 3598 | **Language**: Python
- **License**: NOASSERTION | **Updated**: 2026-09-25
- **Topics**: `agentic-ai` `ai-agents` `artificial-intelligence` `cloud-ml` `computer-systems`
- **Hardware**: Raspberry Pi
...
- **Stars**: 5553 | **Forks**: 616 | **Language**: Python
- **License**: Apache-2.0 | **Updated**: 2026-09-25
- **Topics**: 
- **Simulation**: Mujoco
...
- **Author**: [CSCB](https://github.com/CSCB)
- **Stars**: 1180 | **Forks**: 0 | **Language**: Python
- **License**: AGPL-3.0 | **Updated**: 2026-09-17
- **Topics**: 
...
- **Stars**: 83561 | **Forks**: 11493 | **Language**: None
- **License**: N/A | **Updated**: 2026-09-25
...
- **Stars**: 29988 | **Forks**: 2867 | **Language**: Python
- **License**: Apache-2.0 | **Updated**: 2026-09-25
- **Topics**: 
...
- **Stars**: 27781 | **Forks**: 5741 | **Language**: Python
- **License**: Apache-2.0 | **Updated**: 2026-09-26
- **Topics**: 
...
- **Stars**: 23319 | **Forks**: 2885 | **Language**: TypeScript
- **License**: Apache-2.0 | **Updated**: 2026-09-26
...
- **Stars**: 15336 | **Forks**: 1783 | **Language**: C++
- **License**: Apache-2.0 | **Updated**: 2026-09-26
...
- **Stars**: 14741 | **Forks**: 3096 | **Language**: C++
- **License**: NOASSERTION | **Updated**: 2026-09-25
...
- **Stars**: 11914 | **Forks**: 2567 | **Language**: Python
- **License**: Apache-2.0 | **Updated**: 2026-09-24
...
- **Stars**: 9003 | **Forks**: 3114 | **Language**: C++
- **License**: MIT | **Updated**: 2026-09-25
...
- **Author**: [pollen-robotics](https://github.com/pollen-robotics)
- **Stars**: 8786 | **Forks**: 1129 | **Language**: Rust
- **License**: Apache-2.0 | **Updated**: 2026-09-26
- **Topics**: 
- **Simulation**: Mujoco
...
- **Stars**: 8222 | **Forks**: 3915 | **Language**: Python
- **License**: BSD-3-Clause | **Updated**: 2026-09-26
...
- **Author**: [NVIDIA](https://github.com/NVIDIA)
- **Stars**: 8129 | **Forks**: 1472 | **Language**: Python
- **License**: Apache-2.0 | **Updated**: 2026-09-25
- **Topics**: 
- **Ml Framework**: PyTorch
- **Hardware**: Jetson
...
- **Author**: [NVIDIA](https://github.com/NVIDIA)
- **Stars**: 7148 | **Forks**: 629 | **Language**: Python
- **License**: Apache-2.0 | **Updated**: 2026-09-26
...
- **Stars**: 6722 | **Forks**: 407 | **Language**: Shell
- **License**: NOASSERTION | **Updated**: 2026-09-25
...
- **Stars**: 6086 | **Forks**: 964 | **Language**: None
- **License**: N/A | **Updated**: 2026-09-25
- **Topics**: 
- **Ros**: ROS, ros
...
- **Author**: [cactus-compute](https://github.com/cactus-compute)
- **Stars**: 6062 | **Forks**: 512 | **Language**: C++
- **License**: NOASSERTION | **Updated**: 2026-09-26
- **Topics**: `ai` `android` `arm` `edge` `edge-ai`
...
- **Stars**: 5281 | **Forks**: 790 | **Language**: None
- **License**: Unlicense | **Updated**: 2026-09-26
...
- **Stars**: 4669 | **Forks**: 2068 | **Language**: C++
- **License**: Apache-2.0 | **Updated**: 2026-09-26
...
- **Stars**: 3057 | **Forks**: 497 | **Language**: Python
- **License**: CC0-1.0 | **Updated**: 2026-09-26
- **Topics**: `awesome` `awesome-list` `machine-learning` `motion-planning` `multibody-dynamics`
- **Ros**: ROS, ros
- **Simulation**: Gazebo, PyBullet, Mujoco, Isaac Sim, Isaac Gym
- **Ml Framework**: JAX
- **Hardware**: Arduino
...
- **Stars**: 2636 | **Forks**: 294 | **Language**: C++
- **License**: N/A | **Updated**: 2026-09-24
...
- **Stars**: 2584 | **Forks**: 470 | **Language**: C#
- **License**: NOASSERTION | **Updated**: 2026-09-25
...
- **Stars**: 2535 | **Forks**: 344 | **Language**: Python
- **License**: GPL-3.0 | **Updated**: 2026-09-25
- **Topics**: 
- **Ros**: ROS2, ros2
...
- **Author**: [hku-mars](https://github.com/hku-mars)
- **Stars**: 2458 | **Forks**: 484 | **Language**: C++
- **License**: GPL-2.0 | **Updated**: 2026-09-25
...
- **Stars**: 2399 | **Forks**: 462 | **Language**: Python
- **License**: Apache-2.0 | **Updated**: 2026-09-25
...
- **Stars**: 2093 | **Forks**: 252 | **Language**: Python
- **License**: N/A | **Updated**: 2026-09-23
...
- **Stars**: 2030 | **Forks**: 801 | **Language**: C++
- **License**: BSD-3-Clause | **Updated**: 2026-09-25
- **Topics**: 
- **Ros**: ROS, ros
- **Ros Distro**: Jazzy, Humble
...
- **Stars**: 1885 | **Forks**: 236 | **Language**: Shell
- **License**: N/A | **Updated**: 2026-09-22
- **Topics**: 
- **Ros**: ROS2, ROS, ros, ros2
- **Ros Distro**: Iron, Noetic
...
- **Stars**: 1835 | **Forks**: 567 | **Language**: C++
- **License**: BSD-3-Clause | **Updated**: 2026-09-14
...
- **Stars**: 1809 | **Forks**: 366 | **Language**: C++
- **License**: BSD-3-Clause | **Updated**: 2026-09-23
- **Topics**: 
- **Ros**: ROS, ros
- **Control**: MPC
...
- **Stars**: 1640 | **Forks**: 181 | **Language**: Python
- **License**: Apache-2.0 | **Updated**: 2026-09-24
...
- **Author**: [attify](https://github.com/attify)
- **Stars**: 1607 | **Forks**: 288 | **Language**: Rust
- **License**: NOASSERTION | **Updated**: 2026-09-25
- **Topics**: `binary-analysis` `firmware` `firmware-analysis` `firmware-security` `firmware-tools`
...
- **Stars**: 1516 | **Forks**: 481 | **Language**: C++
- **License**: Apache-2.0 | **Updated**: 2026-09-25
...
- **Stars**: 1504 | **Forks**: 106 | **Language**: Rust
- **License**: Apache-2.0 | **Updated**: 2026-09-25
...
- **Stars**: 1474 | **Forks**: 213 | **Language**: Python
- **License**: Apache-2.0 | **Updated**: 2026-09-25
...
- **Stars**: 1469 | **Forks**: 197 | **Language**: C++
- **License**: Apache-2.0 | **Updated**: 2026-09-25
- **Topics**: 
- **Ros**: ROS2, ROS, ros, ros2
...
- **Stars**: 1417 | **Forks**: 1069 | **Language**: C++
- **License**: N/A | **Updated**: 2026-09-23
...
- **Author**: [reiniscimurs](https://github.com/reiniscimurs)
- **Stars**: 1374 | **Forks**: 193 | **Language**: Python
- **License**: MIT | **Updated**: 2026-09-24
...
- **Stars**: 1310 | **Forks**: 215 | **Language**: C++
- **License**: BSD-3-Clause | **Updated**: 2026-09-25
...
- **Stars**: 1177 | **Forks**: 255 | **Language**: Python
- **License**: NOASSERTION | **Updated**: 2026-09-22
...
- **Stars**: 1161 | **Forks**: 212 | **Language**: JavaScript
- **License**: NOASSERTION | **Updated**: 2026-09-23
- **Topics**: 
- **Ros**: ROS2, ROS, ros, ros2
...
- **Stars**: 1160 | **Forks**: 195 | **Language**: Python
- **License**: MIT | **Updated**: 2026-09-25
- **Topics**: 
- **Ros**: ROS, ros
- **Ml Framework**: OpenCV
...
- **Stars**: 1066 | **Forks**: 96 | **Language**: None
- **License**: N/A | **Updated**: 2026-09-25
- **Topics**: `3d-printing` `automation` `awesome` `awesome-list` `diy`
- **Ros**: ROS2, ROS, ros, ros2
- **Simulation**: Isaac Sim
- **Ml Framework**: Open3D, PCL
- **Hardware**: Arduino, Raspberry Pi, ESP32
...
- **Stars**: 1062 | **Forks**: 121 | **Language**: C++
- **License**: MIT | **Updated**: 2026-09-13
...
- **Stars**: 1005 | **Forks**: 106 | **Language**: Python
- **License**: Apache-2.0 | **Updated**: 2026-09-22
...
- **Stars**: 980 | **Forks**: 473 | **Language**: C++
- **License**: BSD-3-Clause | **Updated**: 2026-09-25
- **Topics**: 
...
- **Author**: [mathiasmantelli](https://github.com/mathiasmantelli)
- **Stars**: 785 | **Forks**: 116 | **Language**: None
- **License**: N/A | **Updated**: 2026-09-16
- **Topics**: `autonomous-robots` `autonomous-systems` `awesome-list` `books` `companies`
- **Ros**: ROS2, ROS, ros, ros2
- **Ros Distro**: Noetic
...
- **Stars**: 688 | **Forks**: 318 | **Language**: C++
- **License**: MIT | **Updated**: 2026-09-23
...
- **Author**: [NVIDIA](https://github.com/NVIDIA)
- **Stars**: 649 | **Forks**: 98 | **Language**: Python
- **License**: Apache-2.0 | **Updated**: 2026-09-25
...
- **Author**: [robocurve](https://github.com/robocurve)
- **Stars**: 606 | **Forks**: 70 | **Language**: Python
- **License**: MIT | **Updated**: 2026-09-25
- **Topics**: `benchmark` `embodied-ai` `evaluation` `physical-ai` `rerun`
- **Ros**: ROS, ros
...
- **Author**: [at-wat](https://github.com/at-wat)
- **Stars**: 601 | **Forks**: 124 | **Language**: C++
- **License**: BSD-3-Clause | **Updated**: 2026-09-14
...
- **Stars**: 578 | **Forks**: 83 | **Language**: Python
- **License**: NOASSERTION | **Updated**: 2026-09-22
...
- **Stars**: 534 | **Forks**: 133 | **Language**: C++
- **License**: NOASSERTION | **Updated**: 2026-08-20
...
- **Stars**: 440 | **Forks**: 31 | **Language**: Rust
- **License**: Apache-2.0 | **Updated**: 2026-09-23
...
- **Stars**: 423 | **Forks**: 81 | **Language**: Python
- **License**: Apache-2.0 | **Updated**: 2026-09-25
- **Topics**: `gazebo-ros` `gazebo-simulator` `gazebosim` `gz` `ignition-gazebo`
- **Ros**: ROS2, ROS, ros, ros2
- **Ros Distro**: Jazzy, Humble, Noetic
- **Simulation**: Gazebo, Mujoco, Isaac Sim
...
- **Author**: [MRPT](https://github.com/MRPT)
- **Stars**: 415 | **Forks**: 61 | **Language**: C++
- **License**: BSD-3-Clause | **Updated**: 2026-09-25
- **Topics**: `gazebo` `mrpt` `robotics` `robots` `ros`
- **Ros**: ROS2, ROS, ros, ros2
- **Ros Distro**: Noetic, Iron, Jazzy, Foxy, Humble
- **Simulation**: Gazebo
...
- **Author**: [NVlabs](https://github.com/NVlabs)
- **Stars**: 412 | **Forks**: 43 | **Language**: Python
- **License**: Apache-2.0 | **Updated**: 2026-09-23
- **Topics**: 
- **Simulation**: Isaac Sim
...
- **Stars**: 386 | **Forks**: 72 | **Language**: Python
- **License**: MIT | **Updated**: 2026-09-20
...
- **Author**: [PRBonn](https://github.com/PRBonn)
- **Stars**: 332 | **Forks**: 48 | **Language**: C++
- **License**: MIT | **Updated**: 2026-09-17
...
- **Stars**: 290 | **Forks**: 50 | **Language**: Python
- **License**: NOASSERTION | **Updated**: 2026-09-14
- **Topics**: 
- **Simulation**: Isaac Sim
...
- **Stars**: 280 | **Forks**: 174 | **Language**: Python
- **License**: BSD-3-Clause | **Updated**: 2026-09-24
- **Topics**: 
- **Ros**: ROS, ros
- **Ros Distro**: Noetic
...
- **Stars**: 261 | **Forks**: 76 | **Language**: C#
- **License**: GPL-3.0 | **Updated**: 2026-08-28
...
- **Stars**: 220 | **Forks**: 60 | **Language**: Python
- **License**: Apache-2.0 | **Updated**: 2026-09-17
...
- **Stars**: 211 | **Forks**: 100 | **Language**: Python
- **License**: GPL-3.0 | **Updated**: 2026-09-24
...
- **Stars**: 66 | **Forks**: 11 | **Language**: Python
- **License**: MIT | **Updated**: 2026-09-07
- **Topics**: 
- **Ros**: ROS, ros
...
- **Stars**: 63 | **Forks**: 12 | **Language**: Python
- **License**: N/A | **Updated**: 2026-08-29
...
- **Author**: [brandonhimpfen](https://github.com/brandonhimpfen)
- **Stars**: 41 | **Forks**: 5 | **Language**: Python
- **License**: N/A | **Updated**: 2026-09-18
- **Topics**: `ai` `awesome` `awesome-list` `awesome-lists` `drone`
- **Ros**: ROS, ros
- **Simulation**: Isaac Sim
- **Control**: MPC
...
- **Stars**: 25 | **Forks**: 9 | **Language**: C++
- **License**: Apache-2.0 | **Updated**: 2026-05-03
- **Topics**: 
- **Ros**: ROS2, ROS, ros, ros2
...
- **Stars**: 22 | **Forks**: 4 | **Language**: C#
- **License**: N/A | **Updated**: 2026-08-25
- **Topics**: 
- **Ros**: ROS, ros
- **Hardware**: Arduino
...
- **Stars**: 14 | **Forks**: 2 | **Language**: Python
...
- **Stars**: 13 | **Forks**: 0 | **Language**: Python
- **License**: N/A | **Updated**: 2026-07-23
- **Topics**: 
- **Simulation**: Isaac Gym



### [SO101-Robotic-Arm-RL](https://github.com/Daevin04/SO101-Robotic-Arm-RL)

> Curriculum reinforcement learning framework for training a 6-DOF SO-101 robotic arm to grasp and manipulate objects using MuJoCo simulation and SAC.

- **Author**: [Daevin04](https://github.com/Daevin04)
- **Stars**: 10 | **Forks**: 0 | **Language**: Python
- **License**: MIT | **Updated**: 2026-09-17
- **Topics**: 
- **Simulation**: Mujoco
...
- **Stars**: 10 | **Forks**: 0 | **Language**: C++
- **License**: MIT | **Updated**: 2026-06-30
- **Topics**: 
- **Ros**: ROS, ros
- **Ros Distro**: Noetic
- **Simulation**: Gazebo
...
### [Autonomous_Mobile_Manipulator](https://github.com/lily-osp/Autonomous_Mobile_Manipulator)
...
- **Author**: [lily-osp](https://github.com/lily-osp)
- **Stars**: 9 | **Forks**: 1 | **Language**: Python
- **License**: MIT | **Updated**: 2026-08-03
...
> This project integrates a UAV with a Delta parallel robot. The arm features a Delta manipulator with an IMU on the end-effector. A base-mounted camera detects the AprilTag on the IMU for real-time visual feedback.

- **Author**: [NHK-DOT](https://github.com/NHK-DOT)
- **Stars**: 5 | **Forks**: 0 | **Language**: C
- **License**: GPL-3.0 | **Updated**: 2026-09-14
- **Topics**: 
- **Ros**: ROS, ros
- **Hardware**: Jetson
...
### [arm-car-simulation](https://github.com/AlexYimAILab/arm-car-simulation)

> A MuJoCo-based mobile manipulator simulation platform with a car chassis and robotic arm, supporting motion control, trajectory planning, and object grasping. References LeRobot and LeKiwi frameworks.

- **Author**: [AlexYimAILab](https://github.com/AlexYimAILab)
- **Stars**: 4 | **Forks**: 0 | **Language**: Python
- **License**: N/A | **Updated**: 2026-05-22
- **Topics**: 
- **Simulation**: Mujoco
...
- **Stars**: 17352 | **Forks**: 1654 | **Language**: Java
- **License**: Apache-2.0 | **Updated**: 2026-09-26
- **Topics**: `apache-arrow` `capital-markets` `database` `historian` `kdb`
...
- **Stars**: 16796 | **Forks**: 3710 | **Language**: JavaScript
- **License**: MIT | **Updated**: 2026-09-23
...
- **Author**: [earthtojake](https://github.com/earthtojake)
- **Stars**: 16371 | **Forks**: 1699 | **Language**: Python
- **License**: MIT | **Updated**: 2026-09-26
- **Topics**: `agents` `ai-agents` `cad` `mechanical-engineering` `robotics`
...
- **Stars**: 16242 | **Forks**: 953 | **Language**: Python
- **License**: MIT | **Updated**: 2026-09-25
...
- **Stars**: 16187 | **Forks**: 1033 | **Language**: None
- **License**: NOASSERTION | **Updated**: 2026-09-26
...
- **Stars**: 12778 | **Forks**: 1003 | **Language**: C
- **License**: MIT | **Updated**: 2026-09-25
- **Topics**: 
...
- **Author**: [cactus-compute](https://github.com/cactus-compute)
- **Stars**: 12626 | **Forks**: 844 | **Language**: Python
- **License**: Apache-2.0 | **Updated**: 2026-09-26
- **Topics**: `cactus` `edge-ai` `foundation-model` `function-calling` `llm`
- **Ml Framework**: JAX
...
- **Stars**: 11495 | **Forks**: 855 | **Language**: Rust
- **License**: Apache-2.0 | **Updated**: 2026-09-25
...
- **Stars**: 10830 | **Forks**: 960 | **Language**: Go
- **License**: Apache-2.0 | **Updated**: 2026-09-25
...
- **Stars**: 10802 | **Forks**: 2282 | **Language**: C#
- **License**: NOASSERTION | **Updated**: 2026-09-25
...
- **Stars**: 9708 | **Forks**: 512 | **Language**: JavaScript
- **License**: Apache-2.0 | **Updated**: 2026-09-26
...
- **Author**: [nasa-jpl](https://github.com/nasa-jpl)
- **Stars**: 9669 | **Forks**: 1507 | **Language**: HTML
- **License**: Apache-2.0 | **Updated**: 2026-09-25
...
- **Stars**: 8086 | **Forks**: 1360 | **Language**: Jupyter Notebook
- **License**: Apache-2.0 | **Updated**: 2026-09-25
...
- **Stars**: 7210 | **Forks**: 2399 | **Language**: C++
- **License**: N/A | **Updated**: 2026-09-25
...
- **Stars**: 7127 | **Forks**: 1407 | **Language**: Python
- **License**: MIT | **Updated**: 2026-09-25
...
- **Stars**: 6797 | **Forks**: 1617 | **Language**: C++
- **License**: MIT | **Updated**: 2026-09-24
...
- **Stars**: 5992 | **Forks**: 1009 | **Language**: TypeScript
- **License**: MIT | **Updated**: 2026-09-19
...
- **Stars**: 1962 | **Forks**: 1039 | **Language**: C++
- **License**: NOASSERTION | **Updated**: 2026-09-23
- **Topics**: 
